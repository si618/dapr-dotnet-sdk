...
namespace Dapr.Client.Test
{
    ...
    public class StateApiTest
    {
            ...
            StateConcurrency expectedConcurrency)
        {
            ...
            state.Metadata.ContainsKey("key1").Should().BeTrue();
            state.Metadata.ContainsKey("key2").Should().BeTrue();
        ...
        private static Autogenerated.GetStateResponse MakeGetStateResponse<T>(T state, string etag = null)
        {
        ...
        private static Autogenerated.GetBulkStateResponse MakeGetBulkStateResponse<T>(string key, T state)
        {
            var data = TypeConverters.ToJsonByteString(state, new JsonSerializerOptions(JsonSerializerDefaults.Web));
        ...
        private static Autogenerated.QueryStateItem MakeQueryStateItem<T>(string key, T data, string etag = default, string error = default)
        {
